...
FIELD_SCHEMA = [
  ...
  {
    "key": "risk_notes",
    "label": "Risk/Compliance Notes",
    "input_type": "textarea",
    "required": true
  }
]
STATUSES = ["logged", "reconciled", "audited", "reported"]
...
def create_app(test_config=None):
    ...
    app.config.update(
        ...
        APP_TITLE="Personalized Workout Bot",
        APP_DESCRIPTION="Production-ready domain application.",
        DOMAIN_LABEL="FinTech",
        ENTITY_SINGULAR="Personalized Workout Ledger Entry",
        ENTITY_PLURAL="Personalized Workout Ledger Entries",
    )
